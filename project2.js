...
window.onload = function init() {
    ...
    document.getElementById("Button2").onclick = function(){axis = xAxis;};
    document.getElementById("Button3").onclick = function(){axis = yAxis;};
    document.getElementById("Button4").onclick = function(){axis = zAxis;};
